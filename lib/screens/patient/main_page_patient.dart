...
import 'package:mohamed/screens/patient/doctor_list.dart';
import 'package:mohamed/screens/patient/home_page.dart';
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: Container(
          decoration: BoxDecoration(
            color: const Color.fromARGB(255, 196, 131, 131),
            ...
            boxShadow: [
              BoxShadow(
                blurRadius: 20,
                color: Color.fromARGB(255, 241, 236, 236).withOpacity(.2),
              ),
            ],
          ),
          child: SafeArea(
            child: Padding(
              ...
              child: GNav(
                ...
                tabBackgroundColor: Color.fromARGB(255, 255, 255, 255).withOpacity(0.7),
