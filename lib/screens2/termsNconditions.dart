        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: const [
              ...
              SizedBox(height: 16),
              Text(
                'Application refers to VitalAge Coach., the software program provided by the Company.',
              ),
              SizedBox(height: 16),
              Text(
                'Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to VitalAge Coach..',
              ),
              SizedBox(height: 16),
              Text(
