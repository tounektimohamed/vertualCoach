...
class CelebritySecond extends StatefulWidget {
  ...
  @override
  _CelebritySecondState createState() => _CelebritySecondState();
}

class _CelebritySecondState extends State<CelebritySecond> {
      ...
      body: Padding(
        ...
        child: Column(
          children: <Widget>[
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                ...
                image: DecorationImage(
                    image: AssetImage('images/mahatma.jpg'), fit: BoxFit.cover),
              ),
            ),
            SizedBox(
            ...
            Text(
              'Q1. Which famous freedom fighter is this?',
            ...
            Column(
              ...
              children: <Widget>[
                ...
                GestureDetector(
                  ...
                  child: Card(
                    color: (answer2) ? Colors.green : Colors.lightBlueAccent,
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(27.0),
                    ),
                    margin: EdgeInsets.symmetric(vertical: 5.0),
                        ...
                        ? RawMaterialButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => CelebrityThird(
                                      fromChooseGame: true,
                                      simonLevel: widget.simonLevel,
                                      celebrityPoints: (answer2)
